...
import { searchListings, setActiveListing } from './GuidedToursPage.duck';
import {
...
const GuidedToursPage = compose(withRouter, connect(mapStateToProps, mapDispatchToProps), injectIntl)(
  SearchPageComponent
);

GuidedToursPage.loadData = (params, search) => {
