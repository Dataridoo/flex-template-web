...
export const MARK_TAB_UPDATED = 'app/EditEventsPage/MARK_TAB_UPDATED';
export const CLEAR_UPDATED_TAB = 'app/EditEventsPage/CLEAR_UPDATED_TAB';

export const CREATE_LISTING_REQUEST = 'app/EditEventsPage/CREATE_LISTING_REQUEST';
export const CREATE_LISTING_SUCCESS = 'app/EditEventsPage/CREATE_LISTING_SUCCESS';
export const CREATE_LISTING_ERROR = 'app/EditEventsPage/CREATE_LISTING_ERROR';

export const UPDATE_LISTING_REQUEST = 'app/EditEventsPage/UPDATE_LISTING_REQUEST';
export const UPDATE_LISTING_SUCCESS = 'app/EditEventsPage/UPDATE_LISTING_SUCCESS';
export const UPDATE_LISTING_ERROR = 'app/EditEventsPage/UPDATE_LISTING_ERROR';

export const SHOW_LISTINGS_REQUEST = 'app/EditEventsPage/SHOW_LISTINGS_REQUEST';
export const SHOW_LISTINGS_SUCCESS = 'app/EditEventsPage/SHOW_LISTINGS_SUCCESS';
export const SHOW_LISTINGS_ERROR = 'app/EditEventsPage/SHOW_LISTINGS_ERROR';

export const UPLOAD_IMAGE_REQUEST = 'app/EditEventsPage/UPLOAD_IMAGE_REQUEST';
export const UPLOAD_IMAGE_SUCCESS = 'app/EditEventsPage/UPLOAD_IMAGE_SUCCESS';
export const UPLOAD_IMAGE_ERROR = 'app/EditEventsPage/UPLOAD_IMAGE_ERROR';

export const UPDATE_IMAGE_ORDER = 'app/EditEventsPage/UPDATE_IMAGE_ORDER';

export const CREATE_LISTING_DRAFT = 'app/EditEventsPage/CREATE_LISTING_DRAFT';
export const UPDATE_LISTING_DRAFT = 'app/EditEventsPage/UPDATE_LISTING_DRAFT';

export const REMOVE_LISTING_IMAGE = 'app/EditEventsPage/REMOVE_LISTING_IMAGE';
