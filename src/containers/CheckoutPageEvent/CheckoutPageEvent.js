...
import { initiateOrder, setInitialValues, speculateTransaction } from './CheckoutPageEvent.duck';
...
export class CheckoutPageEventComponent extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (shouldRedirect) {
      ...
      return <NamedRedirect name="EventsListingPage" params={params} />;
    }
...
CheckoutPageEventComponent.defaultProps = {
...
CheckoutPageEventComponent.propTypes = {
...
const CheckoutPageEvent = compose(withRouter, connect(mapStateToProps, mapDispatchToProps), injectIntl)(
  CheckoutPageEventComponent
);

CheckoutPageEvent.setInitialValues = initialValues => setInitialValues(initialValues);

CheckoutPageEvent.displayName = 'CheckoutPage';

export default CheckoutPageEvent;
