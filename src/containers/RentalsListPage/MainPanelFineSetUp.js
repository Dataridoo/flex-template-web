...
class MainPanelFineSetUp extends Component {
  constructor(props) {
    super(props);
...
MainPanelFineSetUp.defaultProps = {
  className: null,
  rootClassName: null,
  listings: [],
  resultsCount: 0,
...
export default MainPanelFineSetUp;