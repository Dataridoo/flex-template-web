...
export const EditEventProgramFormComponent = props => (
  <FinalForm
    ...
    render={fieldRenderProps => {
      ...
      const eventProgramLabelMessage = intl.formatMessage({
        id: 'EditEventProgramForm.frameLabel',
      });
      const eventProgramPlaceholderMessage = intl.formatMessage({
        id: 'EditEventProgramForm.framePlaceholder',
      });
      ...
      return (
        <Form className={classes} onSubmit={handleSubmit}>
          ...
          <FieldTextInput
            ...
            type="text"
            label={eventProgramLabelMessage}
            placeholder={eventProgramPlaceholderMessage}
          />
