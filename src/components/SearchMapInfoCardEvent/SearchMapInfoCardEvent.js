...
const createURL = (routes, history, listing) => {
  ...
  return createResourceLocatorString('EventsListingPage', routes, pathParams, {});
};
...
class SearchMapInfoCardEvent extends Component {
  constructor(props) {
    super(props);
...
SearchMapInfoCardEvent.defaultProps = {
  className: null,
  rootClassName: null,
  onClickCallback: null,
};

SearchMapInfoCardEvent.propTypes = {
  className: string,
...
export default compose(withRouter, injectIntl)(SearchMapInfoCardEvent);
