...
class EditListingPhotosEventPanel extends Component {
  render() {
    const {
      className,
      rootClassName,
...
EditListingPhotosEventPanel.defaultProps = {
  className: null,
  rootClassName: null,
  errors: null,
  images: [],
...
EditListingPhotosEventPanel.propTypes = {
  className: string,
...
export default EditListingPhotosEventPanel;
