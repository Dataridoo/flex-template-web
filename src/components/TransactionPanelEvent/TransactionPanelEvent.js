...
export class TransactionPanelEventComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
TransactionPanelEventComponent.defaultProps = {
  rootClassName: null,
  className: null,
  currentUser: null,
...
TransactionPanelEventComponent.propTypes = {
...
const TransactionPanelEvent = injectIntl(TransactionPanelEventComponent);

export default TransactionPanelEvent;
