...
const TopbarMobileMenuEvent = props => {
  const {
    isAuthenticated,
    currentPage,
    ...
    return (
      <div className={css.root}>        
        ...
        <div className={css.footer}>
          <NamedLink className={css.createNewListingLink} name="NewEventsListingPage">
...
TopbarMobileMenuEvent.defaultProps = { 
  currentUser: null, 
  notificationCount: 0, 
  currentPage: null,
...
TopbarMobileMenuEvent.propTypes = {
...
export default TopbarMobileMenuEvent;
