...
import css from './SearchFiltersPanelEvents.css';

class SearchFiltersPanelEventsComponent extends Component {
  constructor(props) {
    super(props);
...
SearchFiltersPanelEventsComponent.defaultProps = {
  rootClassName: null,
  className: null,
  filterParamNames: [],
};

SearchFiltersPanelEventsComponent.propTypes = {
...
const SearchFiltersPanelEvents = injectIntl(withRouter(SearchFiltersPanelEventsComponent));

export default SearchFiltersPanelEvents;