...
import { SearchMapInfoCardEvent, SearchMapPriceLabel, SearchMapGroupLabel } from '../../components';
...
export class SearchMapEventComponent extends Component {
  constructor(props) {
    super(props);
...
SearchMapEventComponent.defaultProps = {
  bounds: null,
  center: new sdkTypes.LatLng(60.192049, 24.945831),
...
SearchMapEventComponent.propTypes = {
...
const SearchMapEvent = SearchMapEventComponent;

export default SearchMapEvent;
